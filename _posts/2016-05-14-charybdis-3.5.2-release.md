---
layout: post
title:  "Charybdis 3.5.2 released"
---

We have released a maintenance release for the charybdis 3.5 branch, improving STARTTLS support
for non-OpenSSL backends and providing relevant security patches up to May 14, 2016.

## Downloading charybdis

The charybdis 3.5.2 release can be downloaded via:
